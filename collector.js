...
function sendStaticData(){
    ...
    fetch("https://thechmods.com/api/static", StaticRequestOptions)
...
function sendPerformanceData(){
    ...
    fetch("https://thechmods.com/api/performance", PerformanceRequestOptions)
    .then(response => response.text())
    .catch(error => console.log('error', error));
...
function sendActivityData() {
    ...
    if (count === 0) {
        fetch("https://thechmods.com/api/activity", ActivityRequestOptions)
        ...
        const url = "https://thechmods.com/api/activity/" + activityId;
